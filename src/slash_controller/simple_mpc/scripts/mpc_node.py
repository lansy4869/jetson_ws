...
class MPC(Node):
    def __init__(self):
        ...
        self.nCount = 100
        self.waypoints = self.create_waypoints()MPC Initialized
[INFO] [1764573781.861938853] [mpc_node]: self.Annz_k shape: (208,)
Traceback (most recent call last):
  ...
  File "/opt/ros/foxy/lib/python3.8/site-packages/ament_index_python/resources.py", line 48, in get_resource
    raise LookupError(
LookupError: Could not find the resource 'simple_mpc' of type 'packages'

During handling of the above exception, another exception occurred:

Traceback (most recent call last):
  File "/home/jetson/slash_ws/src/slash_controller/simple_mpc/scripts/mpc_node.py", line 625, in <module>
    main()
  File "/home/jetson/slash_ws/src/slash_controller/simple_mpc/scripts/mpc_node.py", line 608, in main
    PNC_node = MPC()
  File "/home/jetson/slash_ws/src/slash_controller/simple_mpc/scripts/mpc_node.py", line 105, in __init__
    project_file = os.path.join(get_package_share_directory('simple_mpc'), 'waypoints', 'test_waypoints.csv')
...
ament_index_python.packages.PackageNotFoundError: "package 'simple_mpc' not found, searching: ['/opt/ros/foxy']"
